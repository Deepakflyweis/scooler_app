    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          ...
          elevation: 1,
          title: Text('Child Registration', style: appbarTxtStyle,),
          leading: IconButton(
          ...
          child: Column(
            children: [
             ...
             Positioned(
                ...
                child: TextFormField(
                  ...
                  decoration:   InputDecoration(
                    ...
                    suffixIcon: IconButton(
                        icon:  Icon(Icons.keyboard_arrow_down,size: 25,color: blckclr),
                         onPressed: (){},
                        ),
                      hintText: 'Drop Time',
              ...
              Container(
                ...
                child: TextFormField(
                  ...
                  decoration:  InputDecoration(
                      ...
                      border: InputBorder.none,
                      suffixIcon: IconButton(
                          icon: const Icon(Icons.keyboard_arrow_down,size: 25,color: blckclr),
                          onPressed: () {
                            SimpleDialog(
                              children: [
                                SimpleDialogOption(
              ...
              GestureDetector(
                onTap: (){},
                child: Image.asset('assets/images/nextbtn.png', height: 7.h,
